...
boolean resultado;
    ...
    public String metodo1() {
       //obtener placa del carro con mayor tiempo
        String placaMayor="";
        int mayorTiempo=0;
        ...
        if(puesto.estaOcupado()){
            ...
            if(carro.darTiempoEnParqueadero(horaActual)>mayorTiempo){
          mayorTiempo= carro.darTiempoEnParqueadero(horaActual);
          placaMayor=carro.darPlaca();
            }
        }
        }
        return placaMayor;
    ...
    public String metodo2() {
        int lugares=0;
            ...
            if (buscarPuestoLibre() >=lugares) {

                JOptionPane.showMessageDialog(null, "si hay lugares disponibles");
            } else {
